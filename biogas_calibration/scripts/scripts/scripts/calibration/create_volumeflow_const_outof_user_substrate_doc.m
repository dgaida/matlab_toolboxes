%% Syntax
%       create_volumeflow_const_outof_user_substrate(plant_id, method_type)
%       create_volumeflow_const_outof_user_substrate(plant_id, method_type,
%       id_read) 
%       
%% Description
...
% files for all substrates for given plant |plant_id|. The values taken
% from the |volumeflow_..._user.mat| files and written into the
% |volumeflow_..._const.mat| files are defined by |method_type|. The 
...
create_volumeflow_const_outof_user_substrate('sunderhook', 'mean')
