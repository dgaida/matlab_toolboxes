%% txtPopSize_optima_Callback
% Callback of text field txtPopSize_optima
%
function txtPopSize_optima_Callback(hObject, eventdata, handles)
%% Release: 1.3
...
% Hints: get(hObject,'String') returns contents of txtPopSize_optima as text
%        str2double(get(hObject,'String')) returns contents of txtPopSize_optima as a double
