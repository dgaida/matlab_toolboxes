%% txtPopSize_nmpc_Callback
% Callback of text field txtPopSize_nmpc
%
function txtPopSize_nmpc_Callback(hObject, eventdata, handles)
% hObject    handle to txtPopSize_nmpc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of txtPopSize_nmpc as text
%        str2double(get(hObject,'String')) returns contents of txtPopSize_nmpc as a double
