...
%
%% Toolbox
% |txtNoGenerationen_nmpc_Callback| belongs to the _Biogas Plant Modeling_
% Toolbox. 
%
%% Release
...
%
%% Syntax
%       txtNoGenerationen_nmpc_Callback(hObject, eventdata, handles)
%       
%% Description
% |txtNoGenerationen_nmpc_Callback(hObject, eventdata, handles)| is the callback
% of text field txtNoGenerationen_nmpc. It recalculates the estimated time
% needed to solve the optimization problem, which is dependend on the
% number of generations used in the problem.
%
%% Example
% 
%
