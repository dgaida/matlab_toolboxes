%% Syntax
%       pn_cmdLoadPlant_Callback(hObject, eventdata, handles)
%
%% Description
%
% |pn_cmdLoadPlant_Callback(hObject, eventdata, handles)| executes on button
% press in cmdLoadPlant of <gui_plant_network.html gui_plant_network>. A
% <matlab:doc('uigetfile') uigetfile> dialog is shown where the user can
% select a |plant_...xml| file. This is then load and the functions
