%% Syntax
%       cmdEditBHKWs_Callback(hObject, eventdata, handles)
%
%% Description
% |cmdEditBHKWs_Callback(hObject, eventdata, handles)| executes on button
% press in cmdEditBHKWs: Selection of BHKW. Disables elements on gui
% calling <gui_plant_enable_elements.html gui_plant_enable_elements> and 
% creates editing fields for bhkw. 
%
%% Example
% 
%
