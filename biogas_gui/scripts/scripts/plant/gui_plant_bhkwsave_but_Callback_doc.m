%% Syntax
%       gui_plant_bhkwsave_but_Callback(hObject, eventdata, handles)
%
%% Description
% Executes on button press on bhkwsave, bhkwcancel and bhkwreset buttons on
% the right side in the bhkw edit mode. These are the buttons 'OK',
...
%
% <html>
% <a href="cmdeditbhkws_callback.html">
% cmdEditBHKWs_Callback</a>
% </html>
%
%% See Also
% 
