%% Syntax
%       sn_cmdLoadPlant_Callback(hObject, eventdata, handles)
%
%% Description
%
% |sn_cmdLoadPlant_Callback(hObject, eventdata, handles)| executes on button
% press in cmdLoadPlant of <gui_substrate_network.html
