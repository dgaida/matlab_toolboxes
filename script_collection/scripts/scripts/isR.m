%% isR
% Check whether given argument is a real scalar number
%
function isR(argument, argument_name, argument_number, varargin)
%% Release: 1.9
...
if isempty(plusminus)
  validateattributes(argument, {'double'}, {'scalar', 'real'}, ...
                     mfilename, argument_name, argument_number);
else
  if strcmp(plusminus, '+')
    validateattributes(argument, {'double'}, {'scalar', 'real', 'nonnegative'}, ...
                     mfilename, argument_name, argument_number);
  elseif strcmp(plusminus, '-')
    validateattributes(argument, {'double'}, {'scalar', 'real', '<=', 0}, ...
                     mfilename, argument_name, argument_number);
  end
end
