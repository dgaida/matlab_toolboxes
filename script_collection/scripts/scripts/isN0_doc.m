%% Syntax
%       isN0(argument, argument_name, argument_number)
%
%% Description
% |isN0(argument, argument_name, argument_number)| checks if the given
% |argument| is a natural number including zero 0,1,2,3,... The argument
% has the name |argument_name| and is the |argument_number| th argument of
% the calling function. 
%
%%
% @param |argument| : The argument that will be checked. Should be a double
% scalar with value >= 0: 0, 1, 2, 3, ... 
%
%%
