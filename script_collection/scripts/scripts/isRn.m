%% isRn
% Check whether given argument is a real vector
%
function isRn(argument, argument_name, argument_number, varargin)
%% Release: 1.9
...
if isempty(plusminus)
  validateattributes(argument, {'double'}, {'vector', 'nonempty', 'real'}, ...
                     mfilename, argument_name, argument_number);
else
  if strcmp(plusminus, '+')
    validateattributes(argument, {'double'}, {'vector', 'nonempty', 'real', 'nonnegative'}, ...
                     mfilename, argument_name, argument_number);
  elseif strcmp(plusminus, '-')
    validateattributes(argument, {'double'}, {'vector', 'nonempty', 'real', '<=', 0}, ...
                     mfilename, argument_name, argument_number);
  end
end
