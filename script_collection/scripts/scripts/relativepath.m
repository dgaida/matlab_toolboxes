...
[act_path] = fileparts( ...lower  %%%%%%%%% Überarbeitet von Daniel Gaida
                        (act_path) );
[tgt_path] = fileparts( ...lower  %%%%%%%%% Überarbeitet von Daniel Gaida
                        (tgt_path) );
...
elseif  ~isequal(rel_path(1),'.')
   rel_path = [...'.' filesep  %%%%%%%%% Überarbeitet von Daniel Gaida
               rel_path];
end
