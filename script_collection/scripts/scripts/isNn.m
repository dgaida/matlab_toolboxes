%% isNn
% Check whether given argument is a vector of natural numbers 1,2,3,... 
%
function isNn(argument, argument_name, argument_number)
%% Release: 1.9
...
validateattributes(argument, {'double'}, ...
                   {'vector', 'nonempty', 'positive', 'integer', 'real'}, ...
