/**
 * This file defines the class OLR_fit_sensor.
 * 
 * TODOs:
 * - should be ok
 * 
...
namespace biogas
{
  ...
  /// <summary>
  /// Sensor measuring the OLR_fitness of optimization runs
  /// </summary>
  public class OLR_fit_sensor : biogas.sensor
  {
    ...
    /// <summary>
    /// Standard Constructor creating the sensor. Its id is OLR_fit.
    /// </summary>
    public OLR_fit_sensor() :
      base( _spec, "OLR fitness sensor", "")
    {
    ...
    public OLR_fit_sensor(ref XmlTextReader reader, string id) : 
      base(ref reader, id)
    {
      // dimension ist hier 1
    ...
    /// defines specification of sensor
    /// </summary>
    static public string _spec = "OLR_fit";
    ...
    { 
      ...
      double OLR_fitness = sensors.calcFitnessDigester_min_max(myPlant, mySensors, "OLR",
        "max", myFitnessParams, "", true);
