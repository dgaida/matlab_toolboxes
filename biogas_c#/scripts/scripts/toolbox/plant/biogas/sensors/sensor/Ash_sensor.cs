 ...
 */
/**
* This file defines the class Ash_sensor.
* 
* TODOs:
...
namespace biogas
{
  ...
  /// </summary>
  public class Ash_sensor : biogas.sensor
  {
    ...
    public Ash_sensor(string id_suffix) :
    ...
    public Ash_sensor(ref XmlTextReader reader, string id) : 
      base(ref reader, id)
    {
      // type
      _type = 7;
