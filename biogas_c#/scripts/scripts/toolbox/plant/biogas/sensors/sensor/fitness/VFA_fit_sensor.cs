/**
 * This file defines the class VFA_fit_sensor.
 * 
 * TODOs:
 * - should be ok
 * 
...
namespace biogas
{
  ...
  /// <summary>
  /// Sensor measuring the VFA_fitness of optimization runs
  /// </summary>
  public class VFA_fit_sensor : biogas.sensor
  {
    ...
    /// <summary>
    /// Standard Constructor creating the sensor. Its id is VFA_fit.
    /// </summary>
    public VFA_fit_sensor() :
      base( _spec, "VFA fitness sensor", "")
    {
    ...
    public VFA_fit_sensor(ref XmlTextReader reader, string id) : 
      base(ref reader, id)
    {
      // dimension ist hier 1
    ...
    /// defines specification of sensor
    /// </summary>
    static public string _spec = "VFA_fit";
    ...
    { 
      ...
      double VFA_fitness = sensors.calcFitnessDigester_min_max(myPlant, mySensors, "VFA",
