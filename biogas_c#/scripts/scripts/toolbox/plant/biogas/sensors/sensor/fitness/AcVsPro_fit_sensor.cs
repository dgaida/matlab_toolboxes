/**
 * This file defines the class AcVsPro_fit_sensor.
 * 
 * TODOs:
 * - should be ok
 * 
...
namespace biogas
{
  ...
  /// <summary>
  /// Sensor measuring the AcVsPro_fitness of optimization runs
  /// </summary>
  public class AcVsPro_fit_sensor : biogas.sensor
  {
    ...
    /// <summary>
    /// Standard Constructor creating the sensor. Its id is AcVsPro_fit.
    /// </summary>
    public AcVsPro_fit_sensor() :
      base( _spec, "AcVsPro fitness sensor", "")
    {
    ...
    public AcVsPro_fit_sensor(ref XmlTextReader reader, string id) : 
      base(ref reader, id)
    {
      // dimension ist hier 1
    ...
    /// defines specification of sensor
    /// </summary>
    static public string _spec = "AcVsPro_fit";
    ...
    { 
      ...
      double AcVsPro_fitness = sensors.calcFitnessDigester_min_max(myPlant, mySensors, "AcVsPro",
