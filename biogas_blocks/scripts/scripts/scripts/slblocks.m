...
%
blkStruct.Name = ['Biogas Plant Modeling' sprintf('\n') 'Library'];

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'biogas';
...
Browser(1).Library = 'biogas';
Browser(1).Name    = 'Biogas Plant Modeling Toolbox Blockset';
Browser(1).IsFlat  = 0;% Is this library "flat" (i.e. no subsystems)?
...
%@UpdateSimulinkBrokenLinksMappingHelper; 
