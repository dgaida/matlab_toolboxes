%% Syntax
%       rescale_paretoset_SMSEGO(LBold, UBold, LBnew, UBnew, path2file)
%       
%% Description
% |rescale_paretoset_SMSEGO(LBold, UBold, LBnew, UBnew, path2file)| 
%
...
rescale_paretoset_SMSEGO(substrate_network_min, substrate_network_max, LBnew, UBnew, pwd)
...
% ,
% <html>
% <a href="matlab:doc matlab/importdata">
% matlab/importdata</a>
% </html>
%
% and is called by:
