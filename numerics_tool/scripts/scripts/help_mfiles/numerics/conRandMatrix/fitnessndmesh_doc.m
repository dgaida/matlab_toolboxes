%% Syntax
%       [fitness]= fitnessndmesh(obj, u, popSize, fh, LB, UB)
%       [fitness]= fitnessndmesh(obj, u, popSize, fh, LB, UB, nonlcon)
%       [fitness]= fitnessndmesh(obj, u, popSize, fh, LB, UB, nonlcon, A,
%       b) 
%       [fitness, linconstraints]= fitnessndmesh(...)
%
%% Description
% |[fitness]= fitnessndmesh(obj, u, popSize, fh, LB, UB)| evaluates a
% nd-mesh. Tries to maximize distance between vectors stacked together in
% |u|. Therefore it maximizes the distance over n dimensions. At the same
...
%
% If the points in the row vector |u| create a volume, then the n
...
% points in |u|, this must be greater then 1. 
%
...
%
%%
% |[fitness]= fitnessndmesh(obj, u, popSize, fh, LB, UB, nonlcon)| lets you
...
%
%%
% |[fitness]= fitnessndmesh(obj, u, popSize, fh, LB, UB, nonlcon, A, b)|
...
%
%%
% @param |b| : vector of linear inequality constraints. Must
...
% ,
% <html>
% <a href="matlab:doc('matlab/nchoosek')">
% matlab/nchoosek</a>
% </html>
% ,
% <html>
