%% Syntax
%       [fitness]= fitness1dmesh(obj, u, popSize, fh, LB, UB)
%       [fitness]= fitness1dmesh(obj, u, popSize, fh, LB, UB, nonlcon)
%       [fitness]= fitness1dmesh(obj, u, popSize, fh, LB, UB, nonlcon, A,
%       b)
%       [fitness, linconstraints]= fitness1dmesh(...)
%
%% Description
% |[fitness]= fitness1dmesh(obj, u, popSize, fh, LB, UB)| evaluates a
% 1d-mesh. Tries to maximize distance between vectors stacked together in
% |u|, each of these vectors have the size |numel(u)/popSize|. Therefore it
% maximizes the distance in each dimension, here just the first dimension.
% At the same time all boundaries must hold. Boundaries are lower and upper bounds
...
%
%%
% @param |u| : double row vector, the individual, which is assumed to be
...
%
%%
% |[fitness]= fitness1dmesh(obj, u, popSize, fh, LB, UB, nonlcon)| lets you
...
%
%%
% |[fitness]= fitness1dmesh(obj, u, popSize, fh, LB, UB, nonlcon, A, b)|
