...
%
numerics.conSetOfPoints(2, 35, [], [], [], [], [0,0], [5,10], []);
...
% $$(-1, 1) \cdot \vec{x}_i = 0$$
%                 
numerics.conSetOfPoints(2, 15, [], [], [-1, 1], 0, [0,0], [10,10], []);
...
% $$x_2 = 1 + x_1$$
%
numerics.conSetOfPoints(2, 10, [1, 1], 5, [-1, 1], 1, [0,0], [4,4], []);
...
%
numerics.conSetOfPoints(2, 50, [1, -1], 0, [], [], [0,0], [10,10], []);
...
%
numerics.conSetOfPoints(2, 50, [1, -1; -1, 1], [3; 3], [], [], [0,0], [10,10], []);
...
% 
numerics.conSetOfPoints(2, 10, [1, -1; -1, 1], [3; 3], [-1, 1], 0, ...
                            [0,0], [10,10], []);
...
% $$x_2 = 1 + x_1$$
%
numerics.conSetOfPoints(2, 10, [1, 1], 5, [-1, 1], 1, ...
...
% \right] \cdot \vec{x}_i \leq (3, 3)^T$$
%
numerics.conSetOfPoints(2, 50, [1, -1; -1, 1], [3; 3], ...
                            [], [], [0,0], [10,10], ...
